...
# 17 "./MCAL/Timer0/../GPIO/hal_gpio.h"
...
# 1 "./ECU/ecu_led/led.h" 1
# 19 "./ECU/ecu_led/led.h"
typedef struct{
...
# 1 "./MCAL/Timer1/mcal_tmr1.h" 1
# 59 "./MCAL/Timer1/mcal_tmr1.h"
typedef struct{
...
# 1 "./MCAL/Timer2/mcal_tmr2.h" 1
# 27 "./MCAL/Timer2/mcal_tmr2.h"
typedef enum{
...
# 1 "./MCAL/Timer3/mcal_tmr3.h" 1
# 54 "./MCAL/Timer3/mcal_tmr3.h"
typedef struct{
    ...
    uint8 timer3_mood:1;
    uint8 timer3_counter_mood:1;
    uint8 timer3_reg_mood:1;
...
void timer3_timer_init(void){
    ...
    tmr3_counter_obj.timer3_mood = 1;
    tmr3_counter_obj.timer3_prescaler_value = 0;
    tmr3_counter_obj.timer3_preload_value = 0;
    tmr3_counter_obj.timer3_reg_mood = 1;
    tmr3_counter_obj.timer3_counter_mood = 0;
...
void main(void) {
    ...
    while(1){
        ...
        _delay((unsigned long)((150)*(80000000UL/4000.0)));
    }
    return;
}
