...
# 2 "<built-in>" 2
# 1 "MCAL/Timer2/mcal_tmr2.c" 2
# 1 "MCAL/Timer2/mcal_tmr2.h" 1
# 13 "MCAL/Timer2/mcal_tmr2.h"
# 1 "MCAL/Timer2/../GPIO/hal_gpio.h" 1
# 16 "MCAL/Timer2/../GPIO/hal_gpio.h"
...
# 16 "MCAL/Timer2/../GPIO/hal_gpio.h" 2

# 1 "MCAL/Timer2/../GPIO/../mcal_std_types.h" 1
# 17 "MCAL/Timer2/../GPIO/../mcal_std_types.h"
...
# 17 "MCAL/Timer2/../GPIO/../mcal_std_types.h" 2
...
# 17 "MCAL/Timer2/../GPIO/hal_gpio.h" 2
# 36 "MCAL/Timer2/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_PORTA,
    GPIO_PORTB,
    GPIO_PORTC,
...
# 13 "MCAL/Timer2/mcal_tmr2.h" 2

# 1 "MCAL/Timer2/../INTERRUPT/internal_interrupt.h" 1
# 19 "MCAL/Timer2/../INTERRUPT/internal_interrupt.h"
# 1 "MCAL/Timer2/../INTERRUPT/manage_interrupt.h" 1
# 17 "MCAL/Timer2/../INTERRUPT/manage_interrupt.h"
# 1 "MCAL/Timer2/../INTERRUPT/interrupt_config.h" 1
# 17 "MCAL/Timer2/../INTERRUPT/interrupt_config.h"
# 1 "MCAL/Timer2/../INTERRUPT/interrupt_gen_cfg.h" 1
# 17 "MCAL/Timer2/../INTERRUPT/interrupt_config.h" 2
# 51 "MCAL/Timer2/../INTERRUPT/interrupt_config.h"
typedef enum{
    LOW_PRIORITY = 0,
    HIGH_PRIORITY
}interrupt_priority;
# 17 "MCAL/Timer2/../INTERRUPT/manage_interrupt.h" 2
...
void ISR_TMR2(void);
void ISR_TMR3(void);
# 19 "MCAL/Timer2/../INTERRUPT/internal_interrupt.h" 2
# 14 "MCAL/Timer2/mcal_tmr2.h" 2
...
void (*tmr_InterruptHandler)(void) = ((void*)0);
void ISR_TMR2(void);
...
Std_ReturnType Timer2_Init(const Timer2_t *_tmr)
{
    ...
    if(((void*)0) == ret){
        ...
        ret = (Std_ReturnType)1;
        (T2CONbits.TMR2ON = 0);
        (T2CONbits.TOUTPS = _tmr->select_postcale_value);
        (T2CONbits.T2CKPS = _tmr->select_prescaler_value);
