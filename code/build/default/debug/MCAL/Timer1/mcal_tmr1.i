...
# 2 "<built-in>" 2
# 1 "MCAL/Timer1/mcal_tmr1.c" 2
# 1 "MCAL/Timer1/mcal_tmr1.h" 1
# 12 "MCAL/Timer1/mcal_tmr1.h"
# 1 "MCAL/Timer1/../GPIO/hal_gpio.h" 1
# 16 "MCAL/Timer1/../GPIO/hal_gpio.h"
...
# 16 "MCAL/Timer1/../GPIO/hal_gpio.h" 2

# 1 "MCAL/Timer1/../GPIO/../mcal_std_types.h" 1
# 17 "MCAL/Timer1/../GPIO/../mcal_std_types.h"
...
# 17 "MCAL/Timer1/../GPIO/../mcal_std_types.h" 2
...
# 17 "MCAL/Timer1/../GPIO/hal_gpio.h" 2
# 36 "MCAL/Timer1/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_PORTA,
    GPIO_PORTB,
    GPIO_PORTC,
...
# 12 "MCAL/Timer1/mcal_tmr1.h" 2

# 1 "MCAL/Timer1/../INTERRUPT/internal_interrupt.h" 1
# 19 "MCAL/Timer1/../INTERRUPT/internal_interrupt.h"
# 1 "MCAL/Timer1/../INTERRUPT/manage_interrupt.h" 1
# 17 "MCAL/Timer1/../INTERRUPT/manage_interrupt.h"
# 1 "MCAL/Timer1/../INTERRUPT/interrupt_config.h" 1
# 17 "MCAL/Timer1/../INTERRUPT/interrupt_config.h"
# 1 "MCAL/Timer1/../INTERRUPT/interrupt_gen_cfg.h" 1
# 17 "MCAL/Timer1/../INTERRUPT/interrupt_config.h" 2
# 51 "MCAL/Timer1/../INTERRUPT/interrupt_config.h"
typedef enum{
    LOW_PRIORITY = 0,
    HIGH_PRIORITY
}interrupt_priority;
# 17 "MCAL/Timer1/../INTERRUPT/manage_interrupt.h" 2
...
void ISR_TMR0(void);
void ISR_TMR1(void);
# 19 "MCAL/Timer1/../INTERRUPT/internal_interrupt.h" 2
# 13 "MCAL/Timer1/mcal_tmr1.h" 2
...
static __attribute__((inline)) void timer1_mood_select(const Timer1_t *_tmr);
...
Std_ReturnType Timer1_Init(const Timer1_t *_tmr)
{
    ...
    if(((void*)0) == _tmr){
        ...
        (T1CONbits.TMR1ON = 0);
        (T1CONbits.T1CKPS = _tmr->timer1_prescaler_value);
...
static __attribute__((inline)) void timer1_mood_select(const Timer1_t *_tmr)
{
    if(0 == _tmr->timer1_mood){
        (T1CONbits.TMR1CS = 0);
        }
    else if(1 == _tmr->timer1_mood){
        (T1CONbits.TMR1CS = 1);
        if(1 == _tmr->timer1_counter_mood){
            (T1CONbits.T1SYNC = 1);
        }
        else if(0 == _tmr->timer1_counter_mood){
            (T1CONbits.T1SYNC = 0);
        }
        else{
