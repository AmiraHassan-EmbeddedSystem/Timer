...
# 2 "<built-in>" 2
# 1 "MCAL/Timer0/mcal_timer0.c" 2
# 1 "MCAL/Timer0/mcal_timer0.h" 1
# 12 "MCAL/Timer0/mcal_timer0.h"
# 1 "MCAL/Timer0/../GPIO/hal_gpio.h" 1
# 16 "MCAL/Timer0/../GPIO/hal_gpio.h"
...
# 16 "MCAL/Timer0/../GPIO/hal_gpio.h" 2

# 1 "MCAL/Timer0/../GPIO/../mcal_std_types.h" 1
# 17 "MCAL/Timer0/../GPIO/../mcal_std_types.h"
...
# 17 "MCAL/Timer0/../GPIO/../mcal_std_types.h" 2
...
# 17 "MCAL/Timer0/../GPIO/hal_gpio.h" 2
# 36 "MCAL/Timer0/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_PORTA,
    GPIO_PORTB,
    GPIO_PORTC,
...
# 12 "MCAL/Timer0/mcal_timer0.h" 2

# 1 "MCAL/Timer0/../INTERRUPT/internal_interrupt.h" 1
# 19 "MCAL/Timer0/../INTERRUPT/internal_interrupt.h"
# 1 "MCAL/Timer0/../INTERRUPT/manage_interrupt.h" 1
# 17 "MCAL/Timer0/../INTERRUPT/manage_interrupt.h"
# 1 "MCAL/Timer0/../INTERRUPT/interrupt_config.h" 1
# 17 "MCAL/Timer0/../INTERRUPT/interrupt_config.h"
# 1 "MCAL/Timer0/../INTERRUPT/interrupt_gen_cfg.h" 1
# 17 "MCAL/Timer0/../INTERRUPT/interrupt_config.h" 2
# 51 "MCAL/Timer0/../INTERRUPT/interrupt_config.h"
typedef enum{
    LOW_PRIORITY = 0,
    HIGH_PRIORITY
}interrupt_priority;
# 17 "MCAL/Timer0/../INTERRUPT/manage_interrupt.h" 2
...
void ISR_TMR2(void);
void ISR_TMR3(void);
# 19 "MCAL/Timer0/../INTERRUPT/internal_interrupt.h" 2
# 13 "MCAL/Timer0/mcal_timer0.h" 2
# 49 "MCAL/Timer0/mcal_timer0.h"
typedef enum{
    PRESCALER_MOD_2= 0,
    PRESCALER_MOD_4,
    PRESCALER_MOD_8,
...
typedef struct{
    ...
    uint8 clock_source_mood:1;
    uint8 source_edge:1;
    uint8 prescaler_mood:1;
    uint8 reserverd:4;
}Timer0_t;
...
static void (*InterruptHandler)(void) = ((void*)0);


static uint16 timer0_preload = 0;

static __attribute__((inline)) Std_ReturnType timer0_prescaler_config(const Timer0_t *_tmr);
static __attribute__((inline)) Std_ReturnType timer0_mood_select(const Timer0_t *_tmr);
static __attribute__((inline)) Std_ReturnType timer0_register_select_mood(const Timer0_t *_tmr);
...
static __attribute__((inline)) Std_ReturnType timer0_prescaler_config(const Timer0_t *_tmr)
{
    ...
    if(((void*)0) == _tmr){
        ...
        ret = (Std_ReturnType)1;
        if(1 == _tmr->prescaler_mood){
            (T0CONbits.PSA = 0);
            (T0CONbits.T0PS = _tmr->prescaler_value);
        }
        else if(0 == _tmr->prescaler_mood){
            (T0CONbits.PSA = 1);
        }
        else{
            ret = (Std_ReturnType)1;
...
static __attribute__((inline)) Std_ReturnType timer0_mood_select(const Timer0_t *_tmr)
{
    ...
    else if(1 == _tmr->clock_source_mood){
        ret = (Std_ReturnType)1;
        (T0CONbits.T0CS = 0);
        }
    else if(0 == _tmr->clock_source_mood){
        ret = (Std_ReturnType)1;
        (T0CONbits.T0CS = 1);
        if(1 == _tmr->source_edge){
            (T0CONbits.T0SE = 1);
        }
        else if(0 == _tmr->source_edge){
            (T0CONbits.T0SE = 0);
        }
        else{
...
static __attribute__((inline)) Std_ReturnType timer0_register_select_mood(const Timer0_t *_tmr)
{
    ...
    if(((void*)0) == _tmr){
        ...
        ret = (Std_ReturnType)1;
        if(1 == _tmr->register_size){
            (T0CONbits.T08BIT = 1);
        }
        else if(0 == _tmr->register_size){
            (T0CONbits.T08BIT = 0);
        }
        else{
