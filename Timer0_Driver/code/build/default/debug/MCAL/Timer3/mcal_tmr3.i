...
# 2 "<built-in>" 2
# 1 "MCAL/Timer3/mcal_tmr3.c" 2
# 1 "MCAL/Timer3/mcal_tmr3.h" 1
# 12 "MCAL/Timer3/mcal_tmr3.h"
# 1 "MCAL/Timer3/../GPIO/hal_gpio.h" 1
# 16 "MCAL/Timer3/../GPIO/hal_gpio.h"
...
# 16 "MCAL/Timer3/../GPIO/hal_gpio.h" 2

# 1 "MCAL/Timer3/../GPIO/../mcal_std_types.h" 1
# 17 "MCAL/Timer3/../GPIO/../mcal_std_types.h"
...
# 17 "MCAL/Timer3/../GPIO/../mcal_std_types.h" 2
...
# 17 "MCAL/Timer3/../GPIO/hal_gpio.h" 2
# 36 "MCAL/Timer3/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_PORTA,
    GPIO_PORTB,
    GPIO_PORTC,
...
# 12 "MCAL/Timer3/mcal_tmr3.h" 2

# 1 "MCAL/Timer3/../INTERRUPT/internal_interrupt.h" 1
# 19 "MCAL/Timer3/../INTERRUPT/internal_interrupt.h"
# 1 "MCAL/Timer3/../INTERRUPT/manage_interrupt.h" 1
# 17 "MCAL/Timer3/../INTERRUPT/manage_interrupt.h"
# 1 "MCAL/Timer3/../INTERRUPT/interrupt_config.h" 1
# 17 "MCAL/Timer3/../INTERRUPT/interrupt_config.h"
# 1 "MCAL/Timer3/../INTERRUPT/interrupt_gen_cfg.h" 1
# 17 "MCAL/Timer3/../INTERRUPT/interrupt_config.h" 2
# 51 "MCAL/Timer3/../INTERRUPT/interrupt_config.h"
typedef enum{
    LOW_PRIORITY = 0,
    HIGH_PRIORITY
}interrupt_priority;
# 17 "MCAL/Timer3/../INTERRUPT/manage_interrupt.h" 2
...
void ISR_TMR2(void);
void ISR_TMR3(void);
# 19 "MCAL/Timer3/../INTERRUPT/internal_interrupt.h" 2
# 13 "MCAL/Timer3/mcal_tmr3.h" 2
...
void(*Tmr3_InterruptHandler)(void) = ((void*)0);
void ISR_TMR3(void);

uint16 tmr3_preload_data = 0;

static __attribute__((inline)) void timer3_mood_select(const Timer3_t *_tmr);
...
Std_ReturnType Timer3_Init(const Timer3_t *_tmr)
{
    ...
    if(((void*)0) == _tmr){
        ...
        (T3CONbits.TMR3ON = 0);
        (T3CONbits.T3CKPS = _tmr->timer3_prescaler_value);
...
static __attribute__((inline)) void timer3_mood_select(const Timer3_t *_tmr)
{
    if(0 == _tmr->timer3_mood){
        (T3CONbits.TMR3CS = 0);
        }
    else if(1 == _tmr->timer3_mood){
        (T3CONbits.TMR3CS = 1);
        if(1 == _tmr->timer3_counter_mood){
            (T3CONbits.T3SYNC = 1);
        }
        else if(0 == _tmr->timer3_counter_mood){
            (T3CONbits.T3SYNC = 0);
        }
        else{
